...
class ApiPedidos{
    ...
    constructor(){
        this.baseUrl = API_ENDPOINTS.pedidos;
    }
    ...
    async getPedidos(folio: string, queryParams: DocumentosQueryParams = {}): Promise<DocumentosResponsePaginada> {
    ...
    async getDocumentoDetallado(documentoId: string): Promise<DocumentoDetallado> {
        return this.request<DocumentoDetallado>(`/${documentoId}`);
    }
}export const apiPedidos = new ApiPedidos();